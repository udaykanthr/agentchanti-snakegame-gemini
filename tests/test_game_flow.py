...
def test_create_game_initial_state():
    """Verify that create_game helper initializes the game in START state with score 0."""
    g = create_game()
...
def test_score_increment_flow():
    ...
    # Position snake head at (5, 5)
    g.snake.segments = [(5, 5), (5, 6), (5, 7)]
    g.direction = (0, -1) # Up
...
def test_game_over_flow_wall_collision():
    ...
    # Place head at the edge
    g.snake.segments = [(0, 5), (1, 5), (2, 5)]
...
def test_reset_functionality():
    ...
    # Snake should be centered for 20x20: (10, 10), (10, 11), (10, 12)
    assert g.snake.segments[0] == (10, 10)
